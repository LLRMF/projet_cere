...
class FundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fund" do
    assert_difference("Fund.count") do
      post funds_url, params: { fund: { total_amount: @fund.total_amount, user_id: @fund.user_id } }
    end
  ...
  test "should update fund" do
    patch fund_url(@fund), params: { fund: { total_amount: @fund.total_amount, user_id: @fund.user_id } }
