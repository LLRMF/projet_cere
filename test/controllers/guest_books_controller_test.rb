...
class GuestBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guest_book" do
    assert_difference("GuestBook.count") do
      post guest_books_url, params: { guest_book: { message: @guest_book.message, user_id: @guest_book.user_id } }
    end
  ...
  test "should update guest_book" do
    patch guest_book_url(@guest_book), params: { guest_book: { message: @guest_book.message, user_id: @guest_book.user_id } }
