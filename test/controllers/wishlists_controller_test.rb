...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference("Wishlist.count") do
      post wishlists_url, params: { wishlist: { description: @wishlist.description, name: @wishlist.name, user_id: @wishlist.user_id } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { description: @wishlist.description, name: @wishlist.name, user_id: @wishlist.user_id } }
